...
bench_options="--input namd.input --iterations 38 --output namd.test.output"
...
# # running first pass
# ./build/${ISA_build}/gem5.opt $config_file --maxinsts 2000000000 -c $executable --input="$bench_input" --options="$bench_options" 
