...
bench_input="$bench_exec_path/test.txt"
...
# # running first pass
# ./build/${ISA_build}/gem5.opt $config_file --maxinsts 5000000000 -c $executable --input=$bench_input --options="$bench_options" > "outputs/${benchmark}.first.out"
